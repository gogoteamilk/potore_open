...
exports.DEFAULT_CONFIG = {
  ...
  searchFloor: 1,
  searchResultLimit: 4,
  searchFields: ['label', 'value', 'avatar'],
  position: 'auto',
...
function () {
  ...
  Choices.prototype.setChoices = function (choicesArrayOrFetcher, value, label, avatar, replaceChoices) {
    var _this = this;
    ...
    if (typeof choicesArrayOrFetcher === 'function') {
      ...
      if (typeof Promise === 'function' && fetcher_1 instanceof Promise) {
        ...
        .then(function () {
          ...
          return _this.setChoices(data, value, label, avatar, replaceChoices);
        }).catch(function (err) {
      ...
      return this.setChoices(fetcher_1, value, label, avatar, false);
    }
  ...
  Choices.prototype._selectPlaceholderChoice = function (placeholderChoice) {
    this._addItem({
      ...
      avatar: placeholderChoice.avatar,
  ...
  Choices.prototype._addItem = function (_a) {
    var value = _a.value,
        ...
        _h = _a.avatar,
        avatar = _h === void 0 ? null : _h;
    var passedValue = typeof value === 'string' ? value.trim() : value;
    var items = this._store.items;
    var passedLabel = label || passedValue;
    var passedAvatar = avatar || passedAvatar;
  ...
  Choices.prototype._addChoice = function (_a) {
    ...
    var choiceAvatar = avatar || avatar;
    ...
    if (groupChoices) {
      ...
      var addGroupChoices = function addGroupChoices(choice) {
        ...
        _this._addChoice({
          ...
          avatar: utils_1.isType('Object', choice) ? choice[avatarKey] : choice.innerHTML,
          isSelected: choice.selected,
    ...
    case 'ADD_CHOICE':
      {
        ...
        var choice = {
          ...
          avatar: addChoiceAction.avatar || addChoiceAction.value,
...
function () {
  ...
  Input.prototype.setWidth = function () {
    ...
    var _a = this.element,
        ...
        value = _a.value,
        placeholder = _a.placeholder;
    style.minWidth = placeholder.length *2.5 + "ex";
    style.width = value.length *2.5 + "ex";
  };
...
var templates = {
  ...
  option: function option(_a) {
    ...
    var opt = new Option(label, value, avatar, false, active);
